...
@JABBERModule(id="gen-wafbypass",name="WAF Detector",description="Identifies Web Application Firewalls and tests bypass techniques.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.HIGH)
public class WAFBypassModule implements JABBERModuleInterface {
