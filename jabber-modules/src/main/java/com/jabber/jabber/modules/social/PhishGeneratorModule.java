...
@JABBERModule(id="gen-phishgenerator",name="Phishing Email Builder",description="Generates phishing email templates.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.HIGH)
public class PhishGeneratorModule implements JABBERModuleInterface {
