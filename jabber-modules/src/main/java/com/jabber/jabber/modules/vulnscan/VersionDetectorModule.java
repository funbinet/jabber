...
@JABBERModule(id="gen-versiondetector",name="Service Version Detector",description="Banner-grabs services to identify software versions for vulnerability correlation.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.MEDIUM)
public class VersionDetectorModule implements JABBERModuleInterface {
