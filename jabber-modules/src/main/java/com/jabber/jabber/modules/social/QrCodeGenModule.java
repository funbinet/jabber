...
@JABBERModule(id="gen-qrcodegen",name="QR Code Generator",description="Generates QR codes with malicious data.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.MEDIUM)
public class QrCodeGenModule implements JABBERModuleInterface {
