...
@JABBERModule(id="gen-smbnullsession",name="SMB Null Session Checker",description="Tests for SMB null session vulnerabilities via anonymous connection attempts.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.HIGH)
public class SMBNullSessionModule implements JABBERModuleInterface {
