...
@JABBERModule(id="cred-appconfig",name="Application Config Scanning",description="Extract credentials from application configuration files and environment",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.MEDIUM,sourceRef="ConfigParser",author="JABBER")
public class ApplicationConfigModule implements JABBERModuleInterface {
