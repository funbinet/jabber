...
@JABBERModule(id="lateral-golden",name="Golden Ticket",description="Lateral movement via forged Kerberos TGT creation without user password",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.CRITICAL,sourceRef="KirbiTicket",author="JABBER")
public class GoldenTicketModule implements JABBERModuleInterface {
