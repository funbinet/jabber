...
@JABBERModule(id="gen-dirbuster",name="Directory Brute-forcer",description="Discovers hidden web paths and admin panels via HTTP brute-forcing.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.HIGH)
public class DirBusterModule implements JABBERModuleInterface {
