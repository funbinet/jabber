...
@JABBERModule(id="gen-csvexport",name="CSV Exporter",description="Exports findings to CSV spreadsheets.",category=Category.REPORTS,riskLevel=RiskLevel.LOW)
public class CSVExportModule implements JABBERModuleInterface {
