...
@JABBERModule(id="lateral-dcom",name="DCOM Lateral",description="Lateral movement via DCOM object instantiation for RCE",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH,sourceRef="DCOMExec",author="JABBER")
public class DCOMModule implements JABBERModuleInterface {
