...
@JABBERModule(id = "ntlm-relayer", name = "NTLM Relayer",
    ...
    sourceRef = "ntlmrelayx.py", author = "JABBER (derived from @agsolino, Fox-IT, Compass Security)")
public class NTLMRelayerModule implements JABBERModuleInterface {
