...
/**
 * C2 Server Module — Deploy and manage a JABBER Command & Control server.
 * Supports multi-protocol listeners, agent management, kill dates, and malleable traffic.
 */
@JABBERModule(
    id = "c2-server-deploy",
    name = "C2 Server Deployment",
    description = "Deploy and manage a JABBER C2 server with multi-protocol support (HTTP/HTTPS/DNS/WebSocket), agent management, kill dates, working hours, and malleable traffic shaping.",
    category = Category.C2_PERSISTENCE,
    riskLevel = RiskLevel.CRITICAL,
    sourceRef = "JABBER C2 Framework",
    author = "JABBER"
)
public class C2ServerModule implements JABBERModuleInterface {
