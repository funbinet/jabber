...
/**
 * ToolManager — Registry for AD Computer Enumerator tools.
 * Manages: nmap, dig, ldapsearch, rpcclient, net, crackmapexec
 */
public class ToolManager {

    public static final List<ToolDefinition> DEFAULT_TOOLS = List.of(
        ToolDefinition.system("nmap", "Nmap", "Network mapper for OS fingerprinting.",
            List.of("--version"), "https://nmap.org/"),
        ToolDefinition.system("dig", "dig", "DNS query utility for SRV/A records.",
            List.of("-v"), "https://linux.die.net/man/1/dig"),
        ToolDefinition.system("ldapsearch", "ldapsearch", "LDAP querying tool for AD enumeration.",
            List.of("-VV"), "https://linux.die.net/man/1/ldapsearch"),
        ToolDefinition.system("rpcclient", "rpcclient", "MS-RPC client for null sessions and enumeration.",
            List.of("-V"), "https://www.samba.org/samba/docs/current/man-html/rpcclient.1.html"),
        ToolDefinition.system("net", "net", "Samba net utility for domain info.",
            List.of("-V"), "https://www.samba.org/samba/docs/current/man-html/net.8.html"),
    ...
    // Dummy implementations for ToolingModule compliance since these are system tools
    ...
    private Path resolveToolPath(ToolDefinition def) { 
        ...
        // Fallback for crackmapexec which is sometimes netexec or cme
