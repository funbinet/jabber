...
@JABBERModule(id="lateral-ptt",name="Pass-the-Ticket",description="Lateral movement via Kerberos ticket injection without password",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH,sourceRef="Kerberoast",author="JABBER")
public class PassTheTicketModule implements JABBERModuleInterface {
