...
@JABBERModule(id="gen-smsspoof",name="SMS Spoof Builder",description="Creates smishing payloads.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.HIGH)
public class SMSSpoofModule implements JABBERModuleInterface {
