...
@JABBERModule(id="gen-polymorphgen",name="Polymorphic Engine",description="Generates polymorphic payload variants.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH)
public class PolymorphGenModule implements JABBERModuleInterface {
