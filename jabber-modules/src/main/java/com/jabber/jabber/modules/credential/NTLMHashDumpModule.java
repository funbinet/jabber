...
@JABBERModule(id="cred-ntlm",name="NTLM Hash Dumping",description="Extract NTLM hashes from SAM registry and local accounts",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH,sourceRef="SecretsDump",author="JABBER")
public class NTLMHashDumpModule implements JABBERModuleInterface {
