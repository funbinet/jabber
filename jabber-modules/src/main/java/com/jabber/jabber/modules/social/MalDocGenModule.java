...
@JABBERModule(id="gen-maldocgen",name="Malicious Doc Builder",description="Generates macro-enabled document payloads.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.CRITICAL)
public class MalDocGenModule implements JABBERModuleInterface {
