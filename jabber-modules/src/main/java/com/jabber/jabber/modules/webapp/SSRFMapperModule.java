...
@JABBERModule(id="gen-ssrfmapper",name="SSRF Mapper",description="Tests for Server-Side Request Forgery via internal URL injection.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.HIGH)
public class SSRFMapperModule implements JABBERModuleInterface {
