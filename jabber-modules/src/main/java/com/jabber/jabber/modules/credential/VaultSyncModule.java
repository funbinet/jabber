...
@JABBERModule(id="gen-vaultsync",name="Vault Synchronizer",description="Syncs credentials between vaults.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.MEDIUM)
public class VaultSyncModule implements JABBERModuleInterface {
