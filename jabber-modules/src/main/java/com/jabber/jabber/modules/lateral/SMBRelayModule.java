...
@JABBERModule(id="lateral-smbrelay",name="SMB Relay",description="NTLM relay attack to capture and relay authentication to targets",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.CRITICAL,sourceRef="NTLMRelay",author="JABBER")
public class SMBRelayModule implements JABBERModuleInterface {
