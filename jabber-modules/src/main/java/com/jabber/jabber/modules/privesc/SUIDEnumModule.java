...
@JABBERModule(id="gen-suidenum",name="SUID Enumerator",description="Finds SUID/SGID binaries for privesc vectors.",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.MEDIUM)
public class SUIDEnumModule implements JABBERModuleInterface {
