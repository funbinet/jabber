...
@JABBERModule(id="cred-ssh",name="SSH Key Harvesting",description="Extract private SSH keys and known_hosts files",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH,sourceRef="SSHKey",author="JABBER")
public class SSHKeyHarvestModule implements JABBERModuleInterface {
