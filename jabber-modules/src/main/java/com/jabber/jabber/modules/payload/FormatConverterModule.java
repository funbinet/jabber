...
@JABBERModule(id="payload-convert",name="Format Converter",description="Convert payloads between executable formats (EXE, DLL, PS1, ELF, Mach-O, VBS, VBE)",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH,sourceRef="PoC",author="JABBER")
public class FormatConverterModule implements JABBERModuleInterface {
