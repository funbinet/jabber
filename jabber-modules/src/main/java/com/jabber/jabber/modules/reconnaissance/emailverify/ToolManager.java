...
/**
 * ToolManager — Registry for EmailVerifier module tools.
 * Manages: recon-ng, holehe, emailrep, maigret, h8mail, ignorant, katana, curl
 */
public class ToolManager {

    public static final List<ToolDefinition> DEFAULT_TOOLS = List.of(
        ToolDefinition.managed("recon-ng", "recon-ng", "Full-featured Web Reconnaissance framework.",
            List.of("-h"), "https://github.com/lanmaster53/recon-ng", "python3 -m pip install recon-ng --break-system-packages"),
        ...
        ToolDefinition.managed("emailrep", "EmailRep", "Email reputation checking.",
            List.of("--version"), "https://github.com/sublime-security/emailrep.io-cli", "python3 -m pip install emailrep --break-system-packages"),
        ...
        ToolDefinition.downloaded("katana", "Katana", "A next-generation crawling and spidering framework.",
            "katana", List.of("-version"), "https://github.com/projectdiscovery/katana", "go install -v github.com/projectdiscovery/katana/cmd/katana@latest"),
        ToolDefinition.managed("curl", "cURL", "Command line tool and library for transferring data with URLs.",
            List.of("--version"), "https://curl.se/", "sudo apt-get install -y curl"),
    ...
    public List<Map<String, Object>> getToolStatusesForMode(String mode) {
        List<String> activeTools = switch (mode.toUpperCase()) {
            case "PRB" -> List.of("recon-ng", "katana", "curl");
            case "HNT" -> List.of("emailrep");
            case "SOC" -> List.of("maigret", "sherlock");
    ...
    private String findOnPath(String cmd) { 
        ...
        // Fallback for Python tools in ~/.local/bin and other common paths
        if (!isWindows()) {
