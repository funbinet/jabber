...
@JABBERModule(id="gen-kerbtgtreset",name="Kerberos TGT Manager",description="Manages Kerberos TGT and krbtgt operations.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.HIGH)
public class KerbTGTResetModule implements JABBERModuleInterface {
