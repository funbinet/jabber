...
@JABBERModule(id="gen-prefetchreader",name="Prefetch Analyzer",description="Reads Windows Prefetch execution history.",category=Category.FORENSICS,riskLevel=RiskLevel.LOW)
public class PrefetchReaderModule implements JABBERModuleInterface {
