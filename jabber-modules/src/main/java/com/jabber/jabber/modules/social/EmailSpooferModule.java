...
@JABBERModule(id="gen-emailspoofer",name="Email Spoofer",description="Crafts spoofed SMTP email headers.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.CRITICAL)
public class EmailSpooferModule implements JABBERModuleInterface {
