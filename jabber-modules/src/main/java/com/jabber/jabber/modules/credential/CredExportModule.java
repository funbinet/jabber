...
@JABBERModule(id="gen-credexport",name="Credential Exporter",description="Exports credentials for external tools.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.MEDIUM)
public class CredExportModule implements JABBERModuleInterface {
