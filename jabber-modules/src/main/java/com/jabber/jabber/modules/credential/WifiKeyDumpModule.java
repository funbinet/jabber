...
@JABBERModule(id="gen-wifikeydump",name="WiFi Password Extractor",description="Extracts saved WiFi credentials.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.MEDIUM)
public class WifiKeyDumpModule implements JABBERModuleInterface {
