...
@JABBERModule(id="lateral-kerberoast",name="Kerberoasting",description="Service account password cracking via TGS ticket extraction",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.MEDIUM,sourceRef="Kerberoasting",author="JABBER")
public class KerberoastingModule implements JABBERModuleInterface {
