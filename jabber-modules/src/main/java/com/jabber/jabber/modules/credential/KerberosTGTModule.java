...
@JABBERModule(id="cred-tgt",name="Kerberos TGT Extraction",description="Extract and dump Kerberos TGT tickets from memory",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH,sourceRef="Kryptonite",author="JABBER")
public class KerberosTGTModule implements JABBERModuleInterface {
