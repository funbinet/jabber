...
@JABBERModule(id="gen-aesencrypt",name="AES Encryption",description="AES-128/256 encrypt/decrypt in CBC/GCM mode.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.MEDIUM)
public class AESEncryptModule implements JABBERModuleInterface {
