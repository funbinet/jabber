...
@JABBERModule(id="cred-vault",name="Credential Vault Extraction",description="Extract credentials from Windows Credential Manager vault",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH,sourceRef="CredVault",author="JABBER")
public class CredentialVaultModule implements JABBERModuleInterface {
