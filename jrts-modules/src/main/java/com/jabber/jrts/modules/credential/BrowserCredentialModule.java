...
@JRTSModule(id="cred-browser",name="Browser Credential Extraction",description="Extract stored credentials from web browsers (Chrome, Edge, Firefox)",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH,sourceRef="BrowserHistory",author="JRTS")
public class BrowserCredentialModule implements JRTSModuleInterface {
