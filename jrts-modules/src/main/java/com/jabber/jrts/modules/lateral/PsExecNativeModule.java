...
@JRTSModule(id="gen-psexecnative",name="PsExec Native",description="Remote command exec via SMB service creation.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.CRITICAL)
public class PsExecNativeModule implements JRTSModuleInterface {
