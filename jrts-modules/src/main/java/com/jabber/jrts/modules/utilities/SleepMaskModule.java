...
@JRTSModule(id="gen-sleepmask",name="Sleep Mask Persistence",description="In-memory sleep masking with re-encryption.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.MEDIUM)
public class SleepMaskModule implements JRTSModuleInterface {
