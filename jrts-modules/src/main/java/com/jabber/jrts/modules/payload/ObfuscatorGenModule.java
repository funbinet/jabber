...
@JRTSModule(id="gen-obfuscatorgen",name="Code Obfuscator",description="Applies obfuscation to evade detection.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.MEDIUM)
public class ObfuscatorGenModule implements JRTSModuleInterface {
