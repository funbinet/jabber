...
@JRTSModule(id="gen-rdpbrute",name="RDP Credential Tester",description="Tests RDP with credential lists.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH)
public class RDPBruteModule implements JRTSModuleInterface {
