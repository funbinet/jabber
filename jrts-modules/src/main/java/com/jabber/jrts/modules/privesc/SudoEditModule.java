...
@JRTSModule(id="gen-sudoedit",name="Sudo Config Analyzer",description="Parses sudoers for escalation paths.",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.MEDIUM)
public class SudoEditModule implements JRTSModuleInterface {
