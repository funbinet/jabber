...
@JRTSModule(id="gen-urldecode",name="URL Encoder/Decoder",description="Encodes/decodes URL-encoded strings.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class URLDecodeModule implements JRTSModuleInterface {
