...
@JRTSModule(id="gen-browserhistdump",name="Browser History Extractor",description="Extracts browser artifacts and history.",category=Category.FORENSICS,riskLevel=RiskLevel.MEDIUM)
public class BrowserHistDumpModule implements JRTSModuleInterface {
