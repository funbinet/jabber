...
@JRTSModule(id="gen-cookiestealer",name="Cookie Security Analyzer",description="Analyzes cookies for missing Secure, HttpOnly, and SameSite flags.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.MEDIUM)
public class CookieStealerModule implements JRTSModuleInterface {
