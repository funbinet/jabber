...
@JRTSModule(id="gen-chromepass",name="Chrome Credential Extractor",description="Extracts saved Chrome passwords.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH)
public class ChromePassModule implements JRTSModuleInterface {
