...
@JRTSModule(id="gen-sha1brute",name="SHA1 Brute-forcer",description="SHA1 hash cracking via dictionary.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.MEDIUM)
public class SHA1BruteModule implements JRTSModuleInterface {
