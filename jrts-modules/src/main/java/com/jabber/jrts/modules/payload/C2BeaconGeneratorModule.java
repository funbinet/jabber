...
@JRTSModule(id="payload-c2beacon",name="C2 Beacon Generator",description="Generate beacons with encrypted C2 callbacks, embedded staging, and persistence",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.CRITICAL,sourceRef="Cobalt Strike",author="JRTS")
public class C2BeaconGeneratorModule implements JRTSModuleInterface {
