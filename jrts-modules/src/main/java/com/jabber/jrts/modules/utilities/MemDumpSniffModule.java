...
@JRTSModule(id="gen-memdumpsniff",name="Memory Dump Analyzer",description="Parses memory dumps for credentials.",category=Category.FORENSICS,riskLevel=RiskLevel.MEDIUM)
public class MemDumpSniffModule implements JRTSModuleInterface {
