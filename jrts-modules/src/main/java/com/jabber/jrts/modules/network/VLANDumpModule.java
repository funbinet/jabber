...
@JRTSModule(id="gen-vlandump",name="VLAN Enumerator",description="Discovers VLAN configurations via 802.1Q analysis.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.MEDIUM)
public class VLANDumpModule implements JRTSModuleInterface {
