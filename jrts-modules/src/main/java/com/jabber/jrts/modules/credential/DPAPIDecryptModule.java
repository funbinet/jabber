...
@JRTSModule(id="gen-dpapidecrypt",name="DPAPI Decryptor",description="Decrypts DPAPI credential blobs.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.HIGH)
public class DPAPIDecryptModule implements JRTSModuleInterface {
