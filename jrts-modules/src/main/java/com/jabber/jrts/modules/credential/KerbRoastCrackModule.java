...
@JRTSModule(id="gen-kerbroastcrack",name="Kerberoast Cracker",description="Cracks Kerberos TGS tickets.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.HIGH)
public class KerbRoastCrackModule implements JRTSModuleInterface {
