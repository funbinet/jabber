...
@JRTSModule(id="gen-beacondns",name="DNS C2 Channel",description="Creates DNS-based covert C2 channels.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.HIGH)
public class BeaconDNSModule implements JRTSModuleInterface {
