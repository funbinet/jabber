...
@JRTSModule(id="lateral-pth",name="Pass-the-Hash",description="Lateral movement via NTLM hash reuse without plaintext password",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH,sourceRef="psexec, wmiexec",author="JRTS")
public class PassTheHashModule implements JRTSModuleInterface {
