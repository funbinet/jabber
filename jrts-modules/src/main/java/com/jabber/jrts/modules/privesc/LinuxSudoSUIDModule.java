...
@JRTSModule(id="privesc-sudosuid",name="Linux Sudo & SUID",description="Exploit sudo/SUID flaws",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.HIGH,sourceRef="Sudo abuse",author="JRTS")
public class LinuxSudoSUIDModule implements JRTSModuleInterface {
