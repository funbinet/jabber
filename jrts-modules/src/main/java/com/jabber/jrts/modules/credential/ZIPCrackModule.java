...
@JRTSModule(id="gen-zipcrack",name="ZIP Password Cracker",description="Brute-forces ZIP passwords.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.MEDIUM)
public class ZIPCrackModule implements JRTSModuleInterface {
