...
@JRTSModule(id="gen-domainfront",name="Domain Fronting",description="Domain fronting profile configurator.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.HIGH)
public class DomainFrontModule implements JRTSModuleInterface {
