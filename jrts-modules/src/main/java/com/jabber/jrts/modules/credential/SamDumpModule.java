...
@JRTSModule(id="gen-samdump",name="SAM Dumper",description="Extracts local hashes from SAM hive.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.CRITICAL)
public class SamDumpModule implements JRTSModuleInterface {
