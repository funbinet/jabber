...
@JRTSModule(id="gen-wpspin",name="WPS PIN Calculator",description="Computes WPS PINs from BSSID patterns for WPS testing.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.MEDIUM)
public class WPSPinModule implements JRTSModuleInterface {
