...
@JRTSModule(id="gen-wpahandshake",name="WPA Handshake Analyzer",description="Analyzes WPA handshake captures for cracking readiness.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.HIGH)
public class WPAHandshakeModule implements JRTSModuleInterface {
