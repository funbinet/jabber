...
@JRTSModule(id="gen-groupadd",name="Group Membership Manager",description="Adds users to AD security groups.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.HIGH)
public class GroupAddModule implements JRTSModuleInterface {
