...
@JRTSModule(id="gen-rot13crypt",name="ROT13 Cipher",description="Caesar cipher with configurable rotation.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.LOW)
public class ROT13CryptModule implements JRTSModuleInterface {
