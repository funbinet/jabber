...
@JRTSModule(id="gen-ipformat",name="IP Converter",description="Converts IP formats: decimal, hex, octal.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class IPFormatModule implements JRTSModuleInterface {
