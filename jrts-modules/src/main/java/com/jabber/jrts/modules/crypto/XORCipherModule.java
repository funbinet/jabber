...
@JRTSModule(id="gen-xorcipher",name="XOR Cipher",description="XOR encryption for payload encoding.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.MEDIUM)
public class XORCipherModule implements JRTSModuleInterface {
