...
@JRTSModule(id="gen-credimport",name="Credential Importer",description="Imports credentials from various formats.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.MEDIUM)
public class CredImportModule implements JRTSModuleInterface {
