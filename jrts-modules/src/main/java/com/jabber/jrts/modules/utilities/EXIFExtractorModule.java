...
@JRTSModule(id="gen-exifextractor",name="EXIF Metadata Extractor",description="Extracts EXIF metadata from images.",category=Category.FORENSICS,riskLevel=RiskLevel.LOW)
public class EXIFExtractorModule implements JRTSModuleInterface {
