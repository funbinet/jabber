...
@JRTSModule(id="gen-sshkeysteal",name="SSH Key Collector",description="Discovers SSH private keys for lateral movement.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH)
public class SSHKeyStealModule implements JRTSModuleInterface {
