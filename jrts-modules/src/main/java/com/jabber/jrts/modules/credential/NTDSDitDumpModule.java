...
@JRTSModule(id="gen-ntdsditdump",name="NTDS.dit Extractor",description="Extracts hashes from AD NTDS.dit.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.CRITICAL)
public class NTDSDitDumpModule implements JRTSModuleInterface {
