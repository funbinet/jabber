...
@JRTSModule(id="gen-msfvenumwrap",name="MSFvenom Integration",description="Generates MSFvenom payloads.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.HIGH)
public class MSFVenumWrapModule implements JRTSModuleInterface {
