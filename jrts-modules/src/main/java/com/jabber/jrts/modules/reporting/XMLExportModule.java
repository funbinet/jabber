...
@JRTSModule(id="gen-xmlexport",name="XML Exporter",description="Generates XML reports.",category=Category.REPORTS,riskLevel=RiskLevel.LOW)
public class XMLExportModule implements JRTSModuleInterface {
