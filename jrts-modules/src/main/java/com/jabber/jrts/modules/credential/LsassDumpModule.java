...
@JRTSModule(id="gen-lsassdump",name="LSASS Dumper",description="Dumps LSASS for credential extraction.",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.CRITICAL)
public class LsassDumpModule implements JRTSModuleInterface {
