...
@JRTSModule(id="lateral-winrm",name="WinRM Abuse",description="Lateral movement via Windows Remote Management (WinRM) exploitation",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH,sourceRef="WinRM",author="JRTS")
public class WinRMModule implements JRTSModuleInterface {
