...
@JRTSModule(id="gen-pathintercept",name="PATH Interception Finder",description="Finds PATH interception and DLL hijack vectors.",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.MEDIUM)
public class PathInterceptModule implements JRTSModuleInterface {
