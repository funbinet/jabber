...
@JRTSModule(id="gen-revshellgen",name="Reverse Shell Generator",description="Generates reverse shells in multiple languages.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH)
public class RevShellGenModule implements JRTSModuleInterface {
