...
@JRTSModule(id="gen-base64tx",name="Base64 Encoder/Decoder",description="Base64/Base64URL encode/decode.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.LOW)
public class Base64TxModule implements JRTSModuleInterface {
