...
@JRTSModule(id="gen-md5cracker",name="MD5 Cracker",description="Dictionary-based MD5 hash cracker.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.MEDIUM)
public class MD5CrackerModule implements JRTSModuleInterface {
