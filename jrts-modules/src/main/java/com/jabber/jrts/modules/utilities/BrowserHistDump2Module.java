...
@JRTSModule(id="gen-browserhistdump2",name="Browser Forensics",description="Extracts browser artifacts for forensic analysis.",category=Category.FORENSICS,riskLevel=RiskLevel.MEDIUM)
public class BrowserHistDump2Module implements JRTSModuleInterface {
