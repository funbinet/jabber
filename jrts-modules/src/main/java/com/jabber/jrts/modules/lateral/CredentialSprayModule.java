...
@JRTSModule(id="lateral-spray",name="Credential Spraying",description="Lateral movement via multi-user credential spraying across targets",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH,sourceRef="AccountLockout",author="JRTS")
public class CredentialSprayModule implements JRTSModuleInterface {
