...
@JRTSModule(id="gen-mfainterceptor",name="MFA Bypass Analyzer",description="Analyzes MFA for bypass techniques.",category=Category.SOCIAL_ENGINEERING,riskLevel=RiskLevel.HIGH)
public class MFAInterceptorModule implements JRTSModuleInterface {
