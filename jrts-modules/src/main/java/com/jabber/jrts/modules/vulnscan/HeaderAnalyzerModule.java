...
@JRTSModule(id="gen-headeranalyzer",name="HTTP Security Header Analyzer",description="Checks HTTP response headers for missing security controls and misconfigurations.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.MEDIUM)
public class HeaderAnalyzerModule implements JRTSModuleInterface {
