...
@JRTSModule(id="gen-subnetcalculator2",name="Quick CIDR Calculator",description="CIDR notation calculator for network planning.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class SubnetCalculator2Module implements JRTSModuleInterface {
