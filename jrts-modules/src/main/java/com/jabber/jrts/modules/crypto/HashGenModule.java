...
@JRTSModule(id="gen-hashgen",name="Hash Generator",description="Computes MD5/SHA1/SHA256/SHA512 hashes.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.LOW)
public class HashGenModule implements JRTSModuleInterface {
