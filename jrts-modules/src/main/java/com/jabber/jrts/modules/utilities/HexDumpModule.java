...
@JRTSModule(id="gen-hexdump",name="Hex Dump Tool",description="Converts between hex, ASCII, and binary.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class HexDumpModule implements JRTSModuleInterface {
