...
@JRTSModule(id="gen-corsmisconfig",name="CORS Misconfiguration Detector",description="Detects CORS misconfigurations allowing unauthorized cross-domain access.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.MEDIUM)
public class CorsMisconfigModule implements JRTSModuleInterface {
