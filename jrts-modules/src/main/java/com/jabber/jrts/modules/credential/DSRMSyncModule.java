...
@JRTSModule(id="gen-dsrmsync",name="DSRM Synchronizer",description="Syncs DSRM passwords on domain controllers.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.CRITICAL)
public class DSRMSyncModule implements JRTSModuleInterface {
