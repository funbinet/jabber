...
@JRTSModule(id="gen-uacbypass",name="UAC Bypass Generator",description="Generates UAC bypass payloads.",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.HIGH)
public class UACBypassModule implements JRTSModuleInterface {
