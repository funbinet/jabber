...
@JRTSModule(id="gen-bpduattack",name="STP BPDU Analyzer",description="Tests STP for BPDU guard vulnerabilities.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.MEDIUM)
public class BPDUAttackModule implements JRTSModuleInterface {
