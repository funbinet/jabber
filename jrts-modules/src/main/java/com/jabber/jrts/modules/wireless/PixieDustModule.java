...
@JRTSModule(id="gen-pixiedust",name="Pixie Dust Analyzer",description="Analyzes WPS exchanges for offline Pixie Dust feasibility.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.HIGH)
public class PixieDustModule implements JRTSModuleInterface {
