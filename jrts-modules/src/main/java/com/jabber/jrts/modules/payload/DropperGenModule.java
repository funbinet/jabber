...
@JRTSModule(id="gen-droppergen",name="Payload Dropper",description="Creates staged download-execute droppers.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH)
public class DropperGenModule implements JRTSModuleInterface {
