...
@JRTSModule(id="gen-ntlmrainbow",name="NTLM Rainbow Builder",description="NTLM rainbow table generation.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.HIGH)
public class NTLMRainbowModule implements JRTSModuleInterface {
