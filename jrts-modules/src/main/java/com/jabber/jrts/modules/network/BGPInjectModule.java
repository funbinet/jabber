...
@JRTSModule(id="gen-bgpinject",name="BGP Route Analyzer",description="Analyzes BGP routing for hijacking potential.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.HIGH)
public class BGPInjectModule implements JRTSModuleInterface {
