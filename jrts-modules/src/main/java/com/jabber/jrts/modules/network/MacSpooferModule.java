...
@JRTSModule(id="gen-macspoofer",name="MAC Spoofer",description="Changes interface MAC for NAC bypass testing.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.MEDIUM)
public class MacSpooferModule implements JRTSModuleInterface {
