...
@JRTSModule(id="gen-rsakeygen",name="RSA Key Generator",description="Generates RSA key pairs.",category=Category.CRYPTO_OPERATIONS,riskLevel=RiskLevel.LOW)
public class RSAKeyGenModule implements JRTSModuleInterface {
