...
@JRTSModule(id="gen-graphqlintrospect",name="GraphQL Scanner",description="Tests GraphQL endpoints for introspection and schema extraction.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.MEDIUM)
public class GraphQLIntrospectModule implements JRTSModuleInterface {
