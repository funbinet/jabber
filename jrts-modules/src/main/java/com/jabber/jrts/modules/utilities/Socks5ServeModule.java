...
@JRTSModule(id="gen-socks5serve",name="SOCKS5 Server",description="Deploys SOCKS5 proxy for routing.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.MEDIUM)
public class Socks5ServeModule implements JRTSModuleInterface {
