...
@JRTSModule(id="privesc-token",name="Windows Token Impersonation",description="Impersonate Windows tokens",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.HIGH,sourceRef="SeImpersonate",author="JRTS")
public class WindowsTokenImpersonationModule implements JRTSModuleInterface {
