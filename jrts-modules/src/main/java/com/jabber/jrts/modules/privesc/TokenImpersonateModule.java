...
@JRTSModule(id="gen-tokenimpersonate",name="Token Impersonation Checker",description="Checks for token impersonation privileges.",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.HIGH)
public class TokenImpersonateModule implements JRTSModuleInterface {
