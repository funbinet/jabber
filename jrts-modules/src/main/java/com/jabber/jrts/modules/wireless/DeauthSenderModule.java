...
@JRTSModule(id="gen-deauthsender",name="Deauth Frame Builder",description="Constructs 802.11 deauthentication frames for disconnection testing.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.HIGH)
public class DeauthSenderModule implements JRTSModuleInterface {
