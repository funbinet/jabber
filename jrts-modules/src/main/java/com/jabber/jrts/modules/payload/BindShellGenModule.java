...
@JRTSModule(id="gen-bindshellgen",name="Bind Shell Generator",description="Creates bind shell payloads.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH)
public class BindShellGenModule implements JRTSModuleInterface {
