...
@JRTSModule(id="gen-dhcpstarve",name="DHCP Starvation Tester",description="Tests DHCP pool exhaustion vulnerability.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.HIGH)
public class DHCPStarveModule implements JRTSModuleInterface {
