...
@JRTSModule(id="gen-anonymousftp",name="Anonymous FTP Checker",description="Tests FTP servers for anonymous login access.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.HIGH)
public class AnonymousFtpModule implements JRTSModuleInterface {
