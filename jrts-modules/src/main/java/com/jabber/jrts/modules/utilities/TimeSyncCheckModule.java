...
@JRTSModule(id="gen-timesynccheck",name="NTP Time Checker",description="Verifies NTP time sync for Kerberos prereqs.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class TimeSyncCheckModule implements JRTSModuleInterface {
