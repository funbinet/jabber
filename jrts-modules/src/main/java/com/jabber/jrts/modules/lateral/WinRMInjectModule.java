...
@JRTSModule(id="gen-winrminject",name="WinRM Shell",description="Remote PowerShell via WinRM.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.HIGH)
public class WinRMInjectModule implements JRTSModuleInterface {
