...
@JRTSModule(id="gen-eviltwindeploy",name="Evil Twin Configurator",description="Configures rogue access points for evil twin attacks.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.CRITICAL)
public class EvilTwinDeployModule implements JRTSModuleInterface {
