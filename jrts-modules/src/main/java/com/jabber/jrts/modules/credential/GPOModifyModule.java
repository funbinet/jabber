...
@JRTSModule(id="gen-gpomodify",name="GPO Modifier",description="Modifies Group Policy Objects for persistence.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.CRITICAL)
public class GPOModifyModule implements JRTSModuleInterface {
