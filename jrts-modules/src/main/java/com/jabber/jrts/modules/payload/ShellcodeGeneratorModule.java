...
@JRTSModule(id="payload-shellcode",name="Shellcode Generator",description="Generate raw shellcode with optional C2 callback integration (x86/x64)",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH,sourceRef="Metasploit",author="JRTS")
public class ShellcodeGeneratorModule implements JRTSModuleInterface {
