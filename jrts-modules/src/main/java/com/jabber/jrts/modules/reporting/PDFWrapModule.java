...
@JRTSModule(id="gen-pdfwrap",name="PDF Report Wrapper",description="Converts reports to PDF format.",category=Category.REPORTS,riskLevel=RiskLevel.LOW)
public class PDFWrapModule implements JRTSModuleInterface {
