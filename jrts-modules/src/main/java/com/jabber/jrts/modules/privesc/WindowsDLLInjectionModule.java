...
@JRTSModule(id="privesc-dll",name="Windows DLL Injection",description="Exploit DLL injection/hijacking",category=Category.PRIVILEGE_ESCALATION,riskLevel=RiskLevel.HIGH,sourceRef="DLL",author="JRTS")
public class WindowsDLLInjectionModule implements JRTSModuleInterface {
