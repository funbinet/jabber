...
@JRTSModule(id="gen-eventlogexport",name="Event Log Exporter",description="Exports and filters Windows event logs.",category=Category.FORENSICS,riskLevel=RiskLevel.MEDIUM)
public class EventLogExportModule implements JRTSModuleInterface {
