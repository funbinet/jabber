...
@JRTSModule(id="gen-jwtdecrypter",name="JWT Analyzer",description="Decodes JWT tokens and checks for weak algorithms and missing claims.",category=Category.WEB_ASSESSMENT,riskLevel=RiskLevel.MEDIUM)
public class JWTDecrypterModule implements JRTSModuleInterface {
