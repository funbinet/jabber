...
@JRTSModule(id="gen-dcomrelay",name="DCOM Lateral Movement",description="Uses DCOM objects for remote execution.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.CRITICAL)
public class DCOMRelayModule implements JRTSModuleInterface {
