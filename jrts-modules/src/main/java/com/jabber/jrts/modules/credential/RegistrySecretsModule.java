...
@JRTSModule(id="cred-registry",name="Registry Secrets Dumping",description="Extract credentials and secrets from Windows registry",category=Category.CREDENTIAL_ACCESS,riskLevel=RiskLevel.MEDIUM,sourceRef="RegSecrets",author="JRTS")
public class RegistrySecretsModule implements JRTSModuleInterface {
