...
@JRTSModule(id = "ticket-forger", name = "Ticket Forger",
    ...
    sourceRef = "ticketer.py", author = "JRTS (derived from @agsolino)")
public class TicketForgerModule implements JRTSModuleInterface {
