...
@JRTSModule(id="gen-beaconflood",name="Beacon Flood Generator",description="Generates 802.11 beacon frames for wireless stress testing.",category=Category.WIRELESS_HACKING,riskLevel=RiskLevel.HIGH)
public class BeaconFloodModule implements JRTSModuleInterface {
