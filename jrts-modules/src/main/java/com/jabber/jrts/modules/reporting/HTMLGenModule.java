...
@JRTSModule(id="gen-htmlgen",name="HTML Report Generator",description="Generates styled HTML assessment reports.",category=Category.REPORTS,riskLevel=RiskLevel.LOW)
public class HTMLGenModule implements JRTSModuleInterface {
