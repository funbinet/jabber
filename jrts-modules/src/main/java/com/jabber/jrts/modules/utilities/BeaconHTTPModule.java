...
@JRTSModule(id="gen-beaconhttp",name="HTTP C2 Beacon",description="Configures HTTP C2 beacon profiles.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.HIGH)
public class BeaconHTTPModule implements JRTSModuleInterface {
