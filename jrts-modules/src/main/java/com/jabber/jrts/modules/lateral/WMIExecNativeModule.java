...
@JRTSModule(id="gen-wmiexecnative",name="WMI Execution",description="Remote command exec via WMI.",category=Category.LATERAL_MOVEMENT,riskLevel=RiskLevel.CRITICAL)
public class WMIExecNativeModule implements JRTSModuleInterface {
