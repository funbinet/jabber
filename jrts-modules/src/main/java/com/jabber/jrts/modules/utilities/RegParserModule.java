...
@JRTSModule(id="gen-regparser",name="Registry Hive Parser",description="Parses Windows registry hives.",category=Category.FORENSICS,riskLevel=RiskLevel.MEDIUM)
public class RegParserModule implements JRTSModuleInterface {
