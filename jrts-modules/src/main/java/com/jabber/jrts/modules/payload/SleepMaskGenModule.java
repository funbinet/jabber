...
@JRTSModule(id="gen-sleepmaskgen",name="Sleep Mask Generator",description="Creates sleep-masking evasion payloads.",category=Category.PAYLOAD_CREATION,riskLevel=RiskLevel.HIGH)
public class SleepMaskGenModule implements JRTSModuleInterface {
