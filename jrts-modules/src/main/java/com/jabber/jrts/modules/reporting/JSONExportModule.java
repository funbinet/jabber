...
@JRTSModule(id="gen-jsonexport",name="JSON Exporter",description="Exports structured JSON reports.",category=Category.REPORTS,riskLevel=RiskLevel.LOW)
public class JSONExportModule implements JRTSModuleInterface {
