...
@JRTSModule(id="gen-usercreate",name="AD User Creator",description="Creates AD user accounts.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.HIGH)
public class UserCreateModule implements JRTSModuleInterface {
