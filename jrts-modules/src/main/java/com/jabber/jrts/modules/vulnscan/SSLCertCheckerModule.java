...
@JRTSModule(id="gen-sslcertchecker",name="SSL Certificate Inspector",description="Inspects SSL/TLS certificates for expiration, weak algorithms, and chain issues.",category=Category.VULNERABILITY_SCANNING,riskLevel=RiskLevel.MEDIUM)
public class SSLCertCheckerModule implements JRTSModuleInterface {
