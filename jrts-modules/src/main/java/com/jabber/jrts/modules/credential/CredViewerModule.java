...
@JRTSModule(id="gen-credviewer",name="Credential Viewer",description="Browses stored JRTS credentials.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.LOW)
public class CredViewerModule implements JRTSModuleInterface {
