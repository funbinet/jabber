...
@JRTSModule(id="gen-synflooder",name="SYN Flood Simulator",description="TCP SYN flood stress testing tool.",category=Category.NETWORK_ATTACK_DEFENSE,riskLevel=RiskLevel.HIGH)
public class SynFlooderModule implements JRTSModuleInterface {
