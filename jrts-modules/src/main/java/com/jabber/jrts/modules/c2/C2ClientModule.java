...
/**
 * C2 Client/Agent Module — Generate and deploy JRTS C2 agents.
 * Configurable beaconing, protocols, evasion, and callback behavior.
 */
@JRTSModule(
    id = "c2-agent-deploy",
    name = "C2 Agent Generator",
    description = "Generate and deploy JRTS C2 agent implants with configurable beaconing, multi-protocol callback, kill dates, working hours, and traffic shaping.",
    category = Category.C2_PERSISTENCE,
    riskLevel = RiskLevel.CRITICAL,
    sourceRef = "JRTS C2 Framework",
    author = "JRTS"
)
public class C2ClientModule implements JRTSModuleInterface {
