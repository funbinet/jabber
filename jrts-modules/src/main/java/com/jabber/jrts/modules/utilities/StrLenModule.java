...
@JRTSModule(id="gen-strlen",name="String Analyzer",description="Analyzes string length, entropy, and encoding.",category=Category.UTILITIES,riskLevel=RiskLevel.LOW)
public class StrLenModule implements JRTSModuleInterface {
