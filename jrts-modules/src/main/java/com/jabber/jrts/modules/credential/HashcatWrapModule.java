...
@JRTSModule(id="gen-hashcatwrap",name="Hashcat Wrapper",description="Hashcat integration for hash cracking.",category=Category.PASSWORD_CRACKING,riskLevel=RiskLevel.HIGH)
public class HashcatWrapModule implements JRTSModuleInterface {
