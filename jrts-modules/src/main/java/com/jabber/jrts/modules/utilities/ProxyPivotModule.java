...
@JRTSModule(id="gen-proxypivot",name="SOCKS Proxy Pivot",description="SOCKS tunnel through compromised hosts.",category=Category.C2_PERSISTENCE,riskLevel=RiskLevel.HIGH)
public class ProxyPivotModule implements JRTSModuleInterface {
