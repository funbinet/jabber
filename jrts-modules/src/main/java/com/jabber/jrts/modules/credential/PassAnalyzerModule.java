...
@JRTSModule(id="gen-passanalyzer",name="Password Analyzer",description="Analyzes password strength and patterns.",category=Category.SAVED_CREDENTIALS,riskLevel=RiskLevel.LOW)
public class PassAnalyzerModule implements JRTSModuleInterface {
