...
@JRTSModule(id="gen-spnadd",name="SPN Registration",description="Registers SPNs for Kerberoasting.",category=Category.AD_MANAGEMENT,riskLevel=RiskLevel.HIGH)
public class SPNAddModule implements JRTSModuleInterface {
