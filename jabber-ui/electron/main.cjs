...
function createWindow() {
  ...
  let iconPath = path.join(__dirname, '../publichttps://raw.githubusercontent.com/funbinet/jabber-framework/main/jabber-logo.png');
  if (!fs.existsSync(iconPath)) {
    iconPath = path.join(__dirname, '..https://raw.githubusercontent.com/funbinet/jabber-framework/main/jabber-logo.png');
  }
