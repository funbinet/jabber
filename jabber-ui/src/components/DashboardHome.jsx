      ...
      <div className="dashboard-home__hero">
        <div className="dashboard-home__hero-content">
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
            <img src="https://raw.githubusercontent.com/funbinet/jabber-framework/main/jabber-logo.png" 
                 alt="JABBER Logo" style={{ width: '120px', height: '120px', filter: 'drop-shadow(0 0 20px rgba(255,68,68,0.2))' }} />
          </div>
          <h1 style={{ marginBottom: '0.25rem' }}>JABBER</h1>
          <h2 style={{ fontSize: '12px', letterSpacing: '4px', opacity: 0.8 }}>V 5.5.0 PLATFORM</h2>
          <p className="dashboard-home__hero-desc">
            {isConnected
              ? `Engine online with ${totalModules} native modules across ${activeCategories} active categories. V 5.5.0 — unified output management, target profiling, and 30 exploitation modules.`
              : 'Connecting to JABBER backend engine...'}
          </p>
        </div>
      </div>
