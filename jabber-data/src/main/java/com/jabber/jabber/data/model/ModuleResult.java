...
public class ModuleResult {
    ...
    private Map<String, Object> normalizedOutput; // V5.5: raw_output, parsed_output{vulnerable,evidence,details,status}, metadata
    private List<String> logLines;
    private String errorMessage;
    private List<Map<String, Object>> findings;
    private Map<String, String> exportedFiles; // format -> filePath
    private List<String> artifacts; // V5.5: paths to generated files (payloads, etc)
    private Map<String, Object> toolStatuses; // Tool readiness status
    ...
    public Map<String, Object> getToolStatuses() { return toolStatuses; }
    public void setToolStatuses(Map<?, ?> toolStatuses) {
        this.toolStatuses = new LinkedHashMap<>();
        if (toolStatuses != null) {
            toolStatuses.forEach((k, v) -> this.toolStatuses.put(String.valueOf(k), v));
        }
    }
}
